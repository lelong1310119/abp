...
public class TodoWebModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.Conventions.AuthorizePage("/Provinces/Index", TodoPermissions.Provinces.Default);
            options.Conventions.AuthorizePage("/Provinces/CreateModal", TodoPermissions.Provinces.Create);
            options.Conventions.AuthorizePage("/Provinces/EditModal", TodoPermissions.Provinces.Edit);
        });

        Configure<RazorPagesOptions>(options =>
        {
            options.Conventions.AuthorizePage("/Districts/Index", TodoPermissions.Districts.Default);
            options.Conventions.AuthorizePage("/Districts/CreateModal", TodoPermissions.Districts.Create);
            options.Conventions.AuthorizePage("/Districts/EditModal", TodoPermissions.Districts.Edit);
        });
        Configure<RazorPagesOptions>(options =>
        {
            options.Conventions.AuthorizePage("/Communes/Index", TodoPermissions.Communes.Default);
            options.Conventions.AuthorizePage("/Communes/CreateModal", TodoPermissions.Communes.Create);
            options.Conventions.AuthorizePage("/Communes/EditModal", TodoPermissions.Communes.Edit);
        });
    }
